module.exports.config = {
    ...
    version: "1.0",
    hasPermssion: 0,
    credits: "Jukie dựa trên code Hungcatmoi và mod thêm từ Táo", //fix Jukie
...
var name = (await Users.getData(qtv2[i].id)).name
  ...
  var callback = () => api.sendMessage({body:`⏰Thời gian hiện tại: ${gio} !\n📆Hôm nay là: ${ngay}  (${thu})\n\n🌟Tên box: ${threadName}\n👨‍💻ID Box: ${id}\n👀Phê duyệt: ${pd}\n🧠Emoji: ${icon}\n🤙Thông tin:\n👨‍👩‍👦‍👦Tổng ${threadMem} thành viên\n👨‍🦰Nam: ${nam} thành viên \n👩‍🦰Nữ: ${nu} thành viên\n\n👤Với ${qtv} quản trị viên gồm:\n${listad}\n💬Tổng số tin nhắn: ${sl} tin.`,attachment: fs.createReadStream(__dirname + "/cache/2.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/2.png"));
