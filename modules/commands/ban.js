...
module.exports.languages = {
	"vi": {
		...
		"banSuccess": "[📌 Ban User💸 ] Đã xử lý thành công yêu cầu cho vào tù đối với người dùng☣️: %1",
		"unbanSuccess": "[📌 UnBan User💸 ] Đã xử lý thành công yêu cầu cho ra tù đối người dùng☣️ %1",
		...
		"returnBan": "[📌 Ban User💸 ] Hiện Tại Bạn Đang Xem Xét Yêu Cầu Cho\n Người Dùng Đi Tù ⛔\n-Tên Người Dùng:🌸%1\n- ID Cần Đi Tù ☣️ :🌸%1\n\n❮📨 Reaction, Hoặc Thả Cảm Xúc Bất Kỳ.Tin Nhắn Này Để Xác Thực 📌 ❯",
		"returnUnban": "[📌 UnBan User💸 ] Hiện Tại Bạn Đang Xem Xét Yêu Cầu Cho\n Người Dùng ra Tù ⛔\n-Tên Người Dùng:🌸%1`\n- ID Cần ra Tù ☣️ :🌸%1\n\n❮📨 Reaction, Hoặc Thả Cảm Xúc Bất Kỳ.Tin Nhắn Này Để Xác Thực 📌 ❯",
